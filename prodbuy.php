...
echo "<p>".$arrayp['prodDescripLong']."<br></br>"; //display product descip large as contained in the array
echo "<p>$<b>".$arrayp['prodPrice']."</b><br></br>"; //display product price as contained in the array
echo "<p>Left in stock : <b>".$arrayp['prodQuantity']."</b><br></br>"; //display product quantity as contained in the array
